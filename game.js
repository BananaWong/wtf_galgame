...
chapter5_gtc_keynote: [
  ...
  { type:"narration", text:"GTC 当天，下午五点半。\n主会场后台的监控室——\n一整面墙的屏幕：主舞台、观众席、控制台、走廊、休息室。" },
  { type:"narration", text:"你的位置在 demo 控制席。\n戴着耳麦，盯着自己那份屏幕。\n手心一直在出汗。" },
  { type:"text", speaker:"舞台导演", text:"——主持人 OK，灯光 OK，观众已入场。\n黄总后台五分钟。" },
  ...
  { type:"narration", text:"灯光熄灭。\n主舞台后方的巨型 LED 亮起——NVIDIA 那种绿。\n全场屏息。" },
  { type:"narration", text:"——他走上台。" },
  { type:"narration", text:"欢呼声像一道墙压过来。\n你从监控室盯着他——\n他从来没有这么亮过。" },
  ...
  { type:"narration", text:"主屏上——那段你昨晚以为再也跑不起来的代码——开始流畅展开。\n推理速度、token 输出、生成画面。\n精确，干净。" },
  { type:"narration", text:"全场掌声。" },
  { type:"narration", text:"他在台上，朝你这边——监控室——微微点了一下头。" },
  { type:"flag", key:"demo_pressed", value:true },

  { type:"narration", text:"一万两千人的会场。\n欢呼声一浪高过一浪。" },
  { type:"narration", text:"你的 demo 在那块巨屏上跑得稳稳当当——\n仿佛昨晚从来没崩过。" },
  { type:"narration", text:"三十分钟后，他下台。\n人群在他身后久久没散。" },
  ...
  { type:"narration", text:"他带你上了总部楼顶。\n不是那个常有人去的天台——\n是水冷设备后面，一处更小、更僻静的角落。\n两把折叠椅，看上去放了很久。" },
  { type:"text", speaker:"黄仁勋", expression:"smile",
    text:"我有时候一个人来这里坐。\n会场的噪音传不上来。" },
  { type:"text", speaker:"你", text:"……您之前，一个人坐两把椅子？" },
  { type:"text", speaker:"黄仁勋", expression:"shy",
    text:"（顿了一下）……嗯。" },
  { type:"narration", text:"两个人都没再说话。\n远处的城市灯光，一片一片亮着。" },
...
chapter8_confession: [
  ...
  { type:"narration", text:"明天飞回加州。\n他白天的会议结束了，没让你跟最后一场——\n说是：「你早点去吃饭。今晚我想单独跟你聊几句。」" },
  { type:"narration", text:"你站在总部楼下，抬头看那栋透着绿色 logo 的高楼。\n夜风温柔——温柔到让人想做一些不切实际的事。" },
  ...
  { type:"narration", text:"你深吸一口台北的夜风。\n按下电梯。\n42 层。" },
  { type:"narration", text:"——叮。" },
  ...
  { type:"narration", text:"窗外是 101 的灯火。\n屋里是你们最熟悉的那种安静。" },
  { type:"narration", text:"但今晚，这屋里有点不一样的东西在流动。" },

  { type:"narration", text:"——他没坐在桌子后面。\n他站在窗边，背对着你，手里端着一杯没动过的茶。" },
  { type:"text", speaker:"你", text:"……Jensen？" },
  { type:"text", speaker:"黄仁勋", expression:"shy",
    text:"……（慢慢转过身）\n来了。" },
  { type:"narration", text:"你才发现——\n他今天没穿那件皮夹克。" },
  { type:"narration", text:"……是一件你从没见他穿过的、深灰色的薄毛衣。" },
  { type:"text", speaker:"你", text:"……（心脏狂跳）" },
  { type:"narration", text:"——你想起 Colette 那句话：\n「那件皮夹克——如果哪天他在你面前脱掉，那才是真的。」" },
  ...
  { type:"narration", text:"你没出声。\n屋里的光很柔，照在他侧脸上。" },
  { type:"text", speaker:"黄仁勋", expression:"sad",
    text:"做 CEO 三十年，我学会一件事——\n有些位置，是孤独的。\n往上看，只有天花板。\n往下看，都是责任。" },
  { type:"text", speaker:"黄仁勋", expression:"loving",
    text:"但有一段时间，我开始往旁边看。" },
  { type:"narration", text:"他说这话的时候，目光落在你身上。" },
  { type:"text", speaker:"黄仁勋", expression:"loving",
    text:"没有你——或许 GTC 那场 demo 根本跑不起来。\n没有你——董事会那天，我可能真的没撑住那个方向。" },
  { type:"text", speaker:"黄仁勋", expression:"shy",
